...
knitr::opts_knit$set(root.dir = '../.') # sets the root directory to parent directory of the directory where this .rmd file lives in
```
...
```{r weather-variables}
weather17_var <- weather %>% 
	
	group_by(Facility, Grower, Stack, Harvest) %>% 
	
	

# make new data variables

weather17_vars <- weather17 %>% 
	
	group_by(Facility, Grower, Harvest, Stack) %>% 
